...
class ToiletPage extends StatefulWidget {
  static const routeName = '/toilet-page';

  @override
  State createState() => new Toiletstate();
}

class Toiletstate extends State<ToiletPage> {
  var _isInit = true;
  ...
  Future<void> getNearbyPlaces(latitude, longitude) async {
    var url =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=5000&types=toilets&key=AIzaSyDLNRo0MW3EEwVDGjsIH-H-_GXuTVKEiVI";
    print(url);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Nearby Public Toilet '),
      ),
      body: _createContent(),
    );
  }
