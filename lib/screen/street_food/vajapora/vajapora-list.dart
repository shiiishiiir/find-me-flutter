...
class VajaporaList extends StatefulWidget {
  static const routeName = '/vajapora-list';

  @override
  _VajaporaListState createState() => _VajaporaListState();
}

class _VajaporaListState extends State<VajaporaList> {
  final databaseReference = Firestore.instance;
  var patientAndAppointmentId;
  List<dynamic> chotpotiData = List();

  Future reportList() async {
    await databaseReference.collection("vajapora").getDocuments().then((value) {
