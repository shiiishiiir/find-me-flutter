...
class FuchkaList extends StatefulWidget {
  static const routeName = '/fuchka-list';

  @override
  _FuchkaListState createState() => _FuchkaListState();
}

class _FuchkaListState extends State<FuchkaList> {
  final databaseReference = Firestore.instance;
  var patientAndAppointmentId;
  List<dynamic> chotpotiData = List();

  Future reportList() async {
    await databaseReference.collection("fuchka").getDocuments().then((value) {
