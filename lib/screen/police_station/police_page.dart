...
class PolicePage extends StatefulWidget {
  static const routeName = '/police-page';

  @override
  State createState() => new Policestate();
}

class Policestate extends State<PolicePage> {
  var _isInit = true;
  ...
  Future<void> getNearbyPlaces(latitude, longitude) async {
    var url =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=5000&types=police&key=AIzaSyDLNRo0MW3EEwVDGjsIH-H-_GXuTVKEiVI";
    print(url);
